...
class JSON
{
    union BackingData {
        ...
        deque<JSON>        *List;
        std::vector<std::pair<string, JSON>>* Object;
        string             *String;
        double              Float;
        long                Int;
        bool                Bool;
    ...
    public:
        ...
        JSON( JSON&& other )
            ...
            , Type( other.Type )
        { other.Type = Class::Null; other.Internal.Object = nullptr; }

        JSON& operator=( JSON&& other ) {
            ClearInternal();
            Internal = other.Internal;
            Type = other.Type;
            other.Internal.Object = nullptr;
        ...
        JSON( const JSON &other ) {
            ...
            case Class::Object:
                Internal.Object =
                    new std::vector<std::pair<string, JSON>>(other.Internal.Object->begin(),
                        other.Internal.Object->end());
                break;
            case Class::Array:
                Internal.List = 
        ...
        JSON& operator[]( const string &key ) {
            SetType( Class::Object );
            for (auto& entry : *Internal.Object) {
                if (entry.first == key)
                    return entry.second;
            }
        ...
        const JSON& at(const string& key) const {
            for (const auto& entry : *Internal.Object) {
                if (entry.first == key)
                    return entry.second;
            }
        ...
        JSONWrapper<std::vector<std::pair<string, JSON>>> ObjectRange() {
            if (Type == Class::Object)
                return JSONWrapper<std::vector<std::pair<string, JSON>>>(Internal.Object);
            return JSONWrapper<std::vector<std::pair<string, JSON>>>(nullptr);
        }
        ...
        JSONConstWrapper<std::vector<std::pair<string, JSON>>> ObjectRange() const {
            if (Type == Class::Object)
                return JSONConstWrapper<std::vector<std::pair<string, JSON>>>(Internal.Object);
            return JSONConstWrapper<std::vector<std::pair<string, JSON>>>(nullptr);
        }
    ...
    private:
        void SetType( Class type ) {
            ...
            switch( type ) {
            case Class::Null:      Internal.Object    = nullptr;                break;
            case Class::Object:    Internal.Object    = new std::vector<std::pair<string, JSON>>(); break;
...
FVector JSONToFVector(const json::JSON& jsonArr) {
    ...
    // 먼저 JSON 타입이 Array이고 크기가 적어도 3인지 확인합니다.
